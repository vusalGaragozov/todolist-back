...
app.use(cors({
  origin: "https://todolist-front-6hw7chsl6-vusalgaragozov.vercel.app/",
  credentials: true,
...
app.get('/check-auth', (req, res) => {
  if (req.isAuthenticated()) {
    res.header('Access-Control-Allow-Origin', 'https://todolist-front-6hw7chsl6-vusalgaragozov.vercel.app/');
